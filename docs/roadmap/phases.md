...
| Phase | Milestone group | Primary goal |
| --- | --- | --- |
| Phase 0 | Milestone 0 | Repository bootstrap |
| Phase 1 | Milestone 0 | Governance and architecture baseline |
| Phase 2 | Milestone 1 | Rust authority core |
| Phase 3 | Milestone 2 | Context, memory, ledger, replay, audit |
| Phase 4 | Milestone 3 | Provider boundary and model-run control |
