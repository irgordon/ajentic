...
Phase 0 (bootstrap) must complete before Phase 1 can begin.

Phase 1 (governance and architecture baseline) must complete before runtime implementation phases.
