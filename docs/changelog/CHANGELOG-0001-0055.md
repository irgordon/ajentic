...
---
# CHANGELOG archive: v0.0.1 through v0.0.55

This archive preserves historical changelog entries byte-for-byte from the former monolithic `CHANGELOG.md`.

Legacy bootstrap note: `v0.0.0` is retained in this archive to prevent historical omission while the deterministic named range remains `v0.0.1` through `v0.0.55`.
