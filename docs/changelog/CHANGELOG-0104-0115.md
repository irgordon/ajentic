...
---
# CHANGELOG archive: v0.0.104.5 through v0.0.115

This archive preserves historical changelog entries byte-for-byte from the former active `CHANGELOG.md`.

Archive boundary note: this archive starts at `v0.0.104.5` because that completed maintenance entry follows the existing `v0.0.104` archive boundary without rewriting the preserved `CHANGELOG-0056-0104.md` range.
