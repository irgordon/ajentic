...
export function OverviewScreen(): string {
  ...
  return SectionCard({
    ...
    children: [
      ...
      "Operator intent previews are submission-shaped data only in this phase.",
      "No submission occurs from this UI surface.",
      "No Rust ingress call occurs from this UI surface.",
      "No action executes from this preview surface.",
      "No state is mutated.",
