...
use crate::api::{
    ...
    derive_release_candidate_hardening_closure,
    ...
    initial_release_candidate_hardening_closure_projection,
...
pub struct LocalOperatorShellState {
    ...
    pub release_candidate_review: ReleaseCandidateReviewProjection,
    pub release_candidate_hardening_closure: ReleaseCandidateHardeningClosureProjection,
}
...
pub(crate) fn attach_local_session_evidence_export(
    ...
    state.release_candidate_gap_review = derive_release_candidate_gap_review(
        &state.release_candidate_preparation,
        &state.release_artifact_dry_package,
        &state.release_dry_package_checksum_provenance,
        &state.installer_distribution_contract,
        &state.signing_key_custody_dry_run,
        &state.release_candidate_evidence_assembly,
    );
    state.release_candidate_dry_run_rehearsal = derive_release_candidate_dry_run_rehearsal(
        &state.release_candidate_preparation,
        &state.release_artifact_dry_package,
        &state.release_dry_package_checksum_provenance,
        &state.installer_distribution_contract,
    ...
    state.release_candidate_hardening_closure = derive_release_candidate_hardening_closure(
