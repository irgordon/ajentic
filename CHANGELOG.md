...
### Changed
- Extract the controlled internal trial execution helper family from core/src/api/local_operator_shell.rs into a smaller sibling Rust module.
- Preserve public behavior, validation semantics, controlled trial execution projection output, trial run lifecycle behavior, stop-condition observation behavior, manual operator step behavior, evidence linkage behavior, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.20 procedural truth.

### Notes
- Out-of-band maintenance/code-quality phase.
- Behavior-preserving extraction only.
- Controlled trial execution extraction only.
- Controlled internal trial execution projection output is unchanged.
- Trial run lifecycle behavior is unchanged.
- Stop-condition observation behavior is unchanged.
- Manual operator step behavior is unchanged.
- Evidence linkage behavior is unchanged.
- No Phase 171 implementation.
- No release-candidate preparation behavior.
- No runtime behavior changes.
- No TypeScript changes.
...
### Changed
- Extract the provider adapter projection/helper family from core/src/api/local_operator_shell.rs into smaller sibling Rust module files.
- Preserve public behavior, validation semantics, adapter registry projection output, adapter declaration behavior, adapter dry-run behavior, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.18 procedural truth.

### Notes
- Out-of-band maintenance/code-quality phase.
- Behavior-preserving extraction only.
- Provider adapter extraction only.
- Adapter registry projection output is unchanged.
- Adapter declaration validation behavior is unchanged.
- Adapter dry-run behavior is unchanged.
- Provider execution boundaries are unchanged.
- No Phase 171 implementation.
- No release-candidate preparation behavior.
- No runtime behavior changes.
- No TypeScript changes.
...
## v0.0.170.17 - 2026-05-14
**Status:** Phase 170.17 - Out-of-Band Local Operator Shell Session and Restore Extraction

### Changed
- Extract the session / restore projection family from core/src/api/local_operator_shell.rs into smaller sibling Rust module files.
- Preserve public behavior, validation semantics, projection output, deterministic ordering, reason strings, read-back behavior, restore/status classification, and test coverage.
- Update checklists/current-phase.md to Phase 170.17 procedural truth.

### Notes
- Out-of-band maintenance/code-quality phase.
- Behavior-preserving extraction only.
- Session/restore extraction only.
- Session package projection output is unchanged.
- Restore/history projection output is unchanged.
- Read-back projection behavior is unchanged.
- Status classification is unchanged.
- Boundary marker strings are unchanged.
- Capability surface behavior is unchanged.
- No Phase 171 implementation.
...
## v0.0.170.16 - 2026-05-14
**Status:** Phase 170.16 - Out-of-Band Local Operator Shell Projection Extraction

### Changed
- Extract another coherent projection/helper family from `core/src/api/local_operator_shell.rs` into smaller sibling Rust module files.
- Preserve public behavior, validation semantics, projection output, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.16 procedural truth.

### Notes
- Out-of-band maintenance/code-quality phase.
- Behavior-preserving extraction only.
- Projection/helper extraction only.
- Projection output is unchanged.
- Status classification is unchanged.
- Boundary marker strings are unchanged.
- Capability surface behavior is unchanged.
...
## v0.0.170.15 - 2026-05-14
**Status:** Phase 170.15 - Out-of-Band Local Operator Shell Helper Extraction

### Changed
- Extract repeated helper families from `core/src/api/local_operator_shell.rs` into smaller sibling Rust module files.
- Preserve public behavior, validation semantics, boundary marker strings, capability flags, absence marker ordering, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.15 procedural truth.
...
- Boundary marker strings are unchanged.
- Capability surface behavior is unchanged.
- Absence marker behavior is unchanged.
- No Phase 171 implementation.
- No release-candidate preparation behavior.
- No runtime behavior changes.
- No TypeScript changes.
...
## v0.0.170.14 - 2026-05-14
**Status:** Phase 170.14 - Out-of-Band Local Operator Shell Transport Extraction

### Changed
- Extract the local shell transport request/response routing production-code family from `core/src/api/local_operator_shell.rs` into a smaller sibling Rust module.
- Preserve public behavior, request/response variants, state-transition semantics, fail-closed behavior, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.14 procedural truth.

### Notes
- Out-of-band maintenance/code-quality phase.
- Behavior-preserving extraction only.
- Transport extraction only.
- Request/response variants are unchanged.
- State-transition behavior is unchanged.
...
## v0.0.170.13 - 2026-05-14
**Status:** Phase 170.13 - Out-of-Band Local Operator Shell Codec Extraction

### Changed
- Extract the trial package / trial session evidence codec production-code family from `core/src/api/local_operator_shell.rs` into a smaller sibling Rust module.
- Preserve public behavior, validation semantics, serialized formats, deterministic ordering, reason strings, read-back validation behavior, and test coverage.
- Update checklists/current-phase.md to Phase 170.13 procedural truth.

### Notes
- Out-of-band maintenance/code-quality phase.
- Behavior-preserving extraction only.
- Codec extraction only.
- Serialized formats are unchanged.
- Read-back validation behavior is unchanged.
- No Phase 171 implementation.
- No release-candidate preparation behavior.
- No runtime behavior changes.
- No TypeScript changes.
...
## v0.0.170.12 - 2026-05-13
**Status:** Phase 170.12 - Out-of-Band Local Operator Shell Extraction Continuation IV

### Changed
- Extract another coherent production-code family from `core/src/api/local_operator_shell.rs` into smaller sibling Rust module files.
- Preserve public behavior, validation semantics, serialized formats, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.12 procedural truth.
...
## v0.0.170.11 - 2026-05-13
**Status:** Phase 170.11 - Out-of-Band Local Operator Shell Extraction Continuation III

### Changed
- Extract another coherent production-code family from `core/src/api/local_operator_shell.rs` into smaller sibling Rust module files.
- Preserve public behavior, validation semantics, serialized formats, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.11 procedural truth.
...
## v0.0.170.10 - 2026-05-13
**Status:** Phase 170.10 - Out-of-Band Local Operator Shell Extraction Continuation II

### Changed
- Extract another coherent production-code family from `core/src/api/local_operator_shell.rs` into smaller sibling Rust module files.
- Preserve public behavior, validation semantics, serialized formats, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.10 procedural truth.
...
## v0.0.170.9 - 2026-05-13
**Status:** Phase 170.9 - Out-of-Band Local Operator Shell Extraction Continuation

### Changed
- Extract another coherent production-code family from `core/src/api/local_operator_shell.rs` into smaller sibling Rust module files.
- Preserve public behavior, validation semantics, serialized formats, deterministic ordering, reason strings, and test coverage.
- Update checklists/current-phase.md to Phase 170.9 procedural truth.
